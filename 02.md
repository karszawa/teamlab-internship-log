...
- 基本的なWebの知識はあるけれどjQueryやHTML5、CSS3の知識は乏しいプログラマ向けにjQueryをパララックスを題材に解説してくれるサイトを見つけた。 [jQuery×HTML5×CSS3を真面目に勉強](http://www.atmarkit.co.jp/ait/articles/1303/28/news005.html)
...
### http://demo.alessioatzeni.com/klaus/
